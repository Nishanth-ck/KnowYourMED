...
const MedicineInfo = () => {
  ...
  // State for translated medicine details
  ...
  // Function to translate all medicine details
  const translateMedicineDetails = async (details) => {
    const translated = {
      dosage: await translateText(details.dosage),
      ageGroup: await translateText(details.ageGroup),
      sideEffects: await translateText(details.sideEffects),
      purpose: await translateText(details.medicine?.purpose),
      warnings: await translateText(details.medicine?.warnings),
      overdosage: await translateText(details.medicine?.overdosage),
      generalPrecautions: await translateText(
        details.medicine?.general_precautions
      ),
    };
    setTranslatedDetails(translated);
  };

  // Fetch medicine details and translate if language is Kannada
  const fetchMedicineDetails = async (query) => {
    try {
      ...
      setMedicineResults((prevResults) => [
        ...prevResults,
        { name: query, details: details },
      ]);

      // Translate details if language is Kannada
      if (language === "kn") {
        await translateMedicineDetails(details);
      }
  ...
  useEffect(() => {
    if (language === "kn" && medicineResults.length > 0) {
      const latestDetails = medicineResults[medicineResults.length - 1].details;
      translateMedicineDetails(latestDetails);
    }
  }, [language, medicineResults]);
      ...
      {medicineResults.length > 0 && (
        <div className="medicine-card-medinfo">
          ...
          <p>
            ...
            {language === "kn"
              ? sliceText(translatedDetails.dosage)
              : sliceText(
          ...
          <p>
            ...
            {language === "kn"
              ? sliceText(translatedDetails.ageGroup)
              : sliceText(
          ...
          <p>
            ...
            {language === "kn"
              ? sliceText(translatedDetails.sideEffects)
              : sliceText(
          ...
          <p>
            ...
            {language === "kn"
              ? sliceText(translatedDetails.purpose)
              : sliceText(
          ...
          <p>
            ...
            {language === "kn"
              ? sliceText(translatedDetails.warnings)
              : sliceText(
                  medicineResults[medicineResults.length - 1].details.medicine
                    ?.warnings
                )}
          ...
          <p>
            ...
            {language === "kn"
              ? sliceText(translatedDetails.overdosage)
              : sliceText(
                  medicineResults[medicineResults.length - 1].details.medicine
                    ?.overdosage
                )}
          ...
          <p>
            ...
            {language === "kn"
              ? sliceText(translatedDetails.generalPrecautions)
              : sliceText(
                  medicineResults[medicineResults.length - 1].details.medicine
                    ?.general_precautions
                )}
